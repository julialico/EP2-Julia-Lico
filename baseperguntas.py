quest = [{'titulo': 'Qual o resultado da operação 57 + 32?',
         ...
         {'titulo': 'Qual o mês que, dependendo do ano, varia sua quantidade de dias?',
          'nivel': 'facil',
          'opcoes': {'A': 'Março', 'B': 'Fevereiro', 'C': 'Dezembro', 'D': 'Julho'},
          'correta': 'B'},          
         ...
         {'titulo': 'Qual o nome da personagem principal da saga Crepúsculo?',
          'nivel': 'dificil',
          'opcoes': {'A': 'Hermione Granger', 'B': 'Hermione Swan', 'C': 'Bella Cullen', 'D': 'Bella Swan'},
          'correta': 'D'},
